...
const MapWith3DSphere = () => {
  const mapContainer = useRef<HTMLDivElement>(null); // 型をHTMLDivElementに変更

  useEffect(() => {
    if (!mapContainer.current) return; // mapContainerがnullでないことを確認
...
export default MapWith3DSphere;
